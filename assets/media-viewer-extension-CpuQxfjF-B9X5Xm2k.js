import{F as e,N as t,O as n,P as r,n as i,o as a,ot as o,rt as s,st as c}from"./dist-DFIIeeW2.js";import{n as l}from"./fs-access-D-fDaJ8V-D4qvKoNj.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};i.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:e=>e instanceof l&&f(e),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>o`
    ...
    `}};n([r({attribute:!1})],h.prototype,`input`,void 0),n([t()],h.prototype,`mediaUrl`,void 0),n([t()],h.prototype,`imageNaturalWidth`,void 0),n([t()],h.prototype,`imageNaturalHeight`,void 0),n([t()],h.prototype,`overlays`,void 0),h=n([e(`docks-media-viewer`)],h);export{h as DocksMediaViewer};